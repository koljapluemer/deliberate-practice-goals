...
class _Widget extends PanelMenu.Button {
  ...
  _onActivateEntry(actor) {
    ...
    this._saveTextToFile(textValue);
  ...
  _saveTextToFile(text) {
    const currentDateTimeString = GLib.DateTime.new_now_local().format('%Y-%m-%d_%H-%M-%S');
    const savePath = '/home/b/GITHUB/deliberate-practice-recordings/topics/' + currentDateTimeString + '.txt'
    GLib.file_set_contents(savePath, text);
